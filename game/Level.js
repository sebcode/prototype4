...
P4.Level.prototype.skipToNextLevel = function()
{
	...
	for (i = this.stepindex + 1; i < this.sequence.length; i += 1) {
		if (this.sequence[i] && this.sequence[i].level) {
			break
		}
	}
	...
	return 'Level ' + this.sequence[i].level
}
